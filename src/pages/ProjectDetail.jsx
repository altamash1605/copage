...
if (!project) { return ( <div className="min-h-screen flex items-center justify-center text-center text-red-600 font-semibold"> Project not found. </div> ); }

return ( <section className="max-w-4xl mx-auto px-6 py-16 font-josefin"> <h1 className="text-4xl font-bold text-brand mb-4">{project.title}</h1> <p className="text-lg text-gray-700 mb-6">{project.description}</p>
